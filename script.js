// --- DOM Element References ---
        ...
        const studentQrCodeText = document.getElementById('student-qr-code-text');
        const closeStudentAttendanceModalBtn = document.getElementById('close-student-attendance-modal-btn');
        ...
        registerForm.addEventListener('submit', (e) => {
            ...
            const newUser = { name, class: userClass, roll, email, password, isBlocked: false, loginCount: 1, lastLogin: new Date().toLocaleString() };
        ...
        adminAddUserForm.addEventListener('submit', (e) => {
            ...
            const newUser = { name, class: userClass, roll, email, password, isBlocked: false, loginCount: 0, lastLogin: 'Never' };
            registeredUsers.push(newUser);
            recentlyRegisteredUsers.push(newUser);
            saveUsersToLocalStorage();
            renderAdminDashboard();
        ...
        const initializeApp = () => {
            ...
            refreshDashboardBtn.addEventListener('click', renderAdminDashboard);

            closeStudentAttendanceModalBtn.addEventListener('click', () => {
